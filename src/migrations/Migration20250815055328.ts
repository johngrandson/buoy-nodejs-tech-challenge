...
export class Migration20250815055328 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'alter table "accommodation" add column "type" varchar(255) not null, add column "amenities" jsonb null, add column "number_of_rooms" int null, add column "star_rating" int null, add column "number_of_bedrooms" int null, add column "number_of_bathrooms" int null, add column "square_meters" int null, add column "floor" int null, add column "has_elevator" boolean null;'
    );
